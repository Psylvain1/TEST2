...
import tfel_5_1_0_dev.system_5_1_0_dev as tfel_system
...
class PyMFrontMaterialProperty(unittest.TestCase):
    def test_elm(self):
        ...
        elm = tfel_system.ExternalLibraryManager.getExternalLibraryManager()
    ...
    def test_externalmaterialpropertydescription(self):
        ...
        l = os.environ['MFRONT_MATERIAL_PROPERTY_LIBRARY']
        mp = os.environ['MFRONT_MATERIAL_PROPERTY_FUNCTION']
        emp = tfel_system.ExternalMaterialPropertyDescription(l, mp)
