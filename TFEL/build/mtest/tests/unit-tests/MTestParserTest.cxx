...
// error reports
#line 21 "/home/sylv/TFEL/tfel/mtest/tests/unit-tests/MTestParserTest.cxx.in"
...
struct MTestParserTest final : public tfel::tests::TestCase {
  MTestParserTest()
      ...
      castem_library([]{const auto e = ::getenv("MFrontCastemBehavioursBuildPath");
	  return e == nullptr ? std::string{} : e;}()),
      aster_library([]{const auto e = ::getenv("MFrontAsterBehavioursBuildPath");
	  return e == nullptr ? std::string{} : e;}()),
      cyrano_library([]{const auto e = ::getenv("MFrontCyranoBehavioursBuildPath");
	  return e == nullptr ? std::string{} : e;}())
...
#ifdef HAVE_CASTEM
    this->check(this->castem_library, "umat");
    this->check2(this->castem_library, "umat");
#endif
#ifdef HAVE_ASTER
    this->check(this->aster_library, "aster");
    this->check2(this->castem_library, "umat");
#endif
#ifdef HAVE_CYRANO
    this->check(this->cyrano_library, "cyrano",
...
private:
  const std::string castem_library;
  const std::string aster_library;
  const std::string cyrano_library;
};
